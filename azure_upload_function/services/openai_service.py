...
- Chart answer: {{"type":"chart","chart_type":"bar|line|pie|area|scatter|histogram|radar|heatmap|funnel|treemap|composed","labels":["A","B"],"values":[1,2],"answer":"optional summary"}}

CHART TYPE SELECTION:
- bar: category comparisons, counts
